...
{
    public class ApprovalAuthorityMappingProfile : Profile
    {
        public ApprovalAuthorityMappingProfile()
        {
            CreateMap<ApprovalAuthority, ApprovalAuthorityGetDto>()
            ...
            CreateMap<ApprovalAuthorityCreateDto, ApprovalAuthority>()
            ...
            CreateMap<ApprovalAuthorityUpdateDto, ApprovalAuthority>()
