...
{
    public class QuotationExchangeRateMappingProfile : Profile
    {
        public QuotationExchangeRateMappingProfile()
        {
            // QuotationExchangeRate mappings
            CreateMap<QuotationExchangeRate, QuotationExchangeRateGetDto>()
            ...
            CreateMap<QuotationExchangeRateCreateDto, QuotationExchangeRate>()
            ...
            CreateMap<QuotationExchangeRateUpdateDto, QuotationExchangeRate>()
