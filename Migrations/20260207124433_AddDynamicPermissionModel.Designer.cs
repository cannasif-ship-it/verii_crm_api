...
namespace crm_api.Migrations
{
    ...
    [Migration("20260207124433_AddDynamicPermissionModel")]
    partial class AddDynamicPermissionModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("crm_api.Modules.Integrations.Domain.Entities.SmtpSetting", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedDate = new DateTime(2026, 2, 7, 12, 44, 32, 621, DateTimeKind.Utc).AddTicks(3640),
                            EnableSsl = true,
                            FromEmail = "",
            ...
            modelBuilder.Entity("crm_api.Modules.Customer.Domain.Entities.Contact", b =>
                {
                    ...
                    b.HasOne("crm_api.Models.Title", "Titles")
                        .WithMany("Contacts")
