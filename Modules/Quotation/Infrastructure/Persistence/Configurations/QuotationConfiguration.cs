...
namespace crm_api.Modules.Quotation.Infrastructure.Persistence.Configurations
{
    public class QuotationConfiguration : BaseEntityConfiguration<QuotationEntity>
    {
        protected override void ConfigureEntity(EntityTypeBuilder<QuotationEntity> builder)
        {
            // Table name
