using AutoMapper;
using OrderEntity = crm_api.Modules.Order.Domain.Entities.Order;
...
namespace crm_api.Modules.Quotation.Application.Services
{
    public class QuotationService : IQuotationService
    {
        ...
        [
            nameof(QuotationEntity.OfferNo),
            nameof(QuotationEntity.Currency),
        ...
        public async Task<ApiResponse<PagedResponse<QuotationGetDto>>> GetAllQuotationsAsync(PagedRequest request)
        {
            try
            {
                ...
                var sortBy = request.SortBy ?? nameof(QuotationEntity.Id);
        ...
        public async Task<ApiResponse<QuotationDto>> CreateQuotationAsync(CreateQuotationDto createQuotationDto)
        {
            try
            {
                var quotation = _mapper.Map<QuotationEntity>(createQuotationDto);
        ...
        public async Task<ApiResponse<QuotationGetDto>> CreateQuotationBulkAsync(QuotationBulkCreateDto bulkDto)
        {
            ...
            try
            {
                ...
                // 1. Header map
                var quotation = _mapper.Map<QuotationEntity>(bulkDto.Quotation);
        ...
        public async Task<ApiResponse<QuotationGetDto>> CreateRevisionOfQuotationAsync(long quotationId)
        {
            ...
            try
            {
                ...
                var newQuotation = new QuotationEntity();
