...
namespace crm_api.Modules.Integrations.Application.Services
{
    public class GoogleCalendarService : IGoogleCalendarService
    {
        ...
        public async Task<string> CreateActivityEventAsync(long userId, ActivityEntity activity, CancellationToken cancellationToken = default)
        {
            var accessToken = await EnsureSyncReadyAndGetAccessTokenAsync(userId, cancellationToken).ConfigureAwait(false);
        ...
        public async Task<string> SyncActivityEventAsync(long userId, ActivityEntity activity, CancellationToken cancellationToken = default)
        {
            var accessToken = await EnsureSyncReadyAndGetAccessTokenAsync(userId, cancellationToken).ConfigureAwait(false);
        ...
        private static object BuildActivityEventRequestBody(ActivityEntity activity)
        {
        ...
        private static object BuildRemindersPayload(ActivityEntity activity)
        {
