...
namespace crm_api.Modules.Integrations.Application.Services
{
    public class OutlookEntegrationService : IOutlookEntegrationService
    {
        ...
        {
            var randomState = WebEncoders.Base64UrlEncode(RandomNumberGenerator.GetBytes(32));
