...
namespace crm_api.Modules.Approval.Application.Mappings
{
    public class ApprovalRoleMappingProfile : Profile
    {
        public ApprovalRoleMappingProfile()
        {
            // ApprovalRole mappings
            CreateMap<ApprovalRole, ApprovalRoleGetDto>()
            ...
            CreateMap<ApprovalRoleCreateDto, ApprovalRole>()
            ...
            CreateMap<ApprovalRoleUpdateDto, ApprovalRole>()
