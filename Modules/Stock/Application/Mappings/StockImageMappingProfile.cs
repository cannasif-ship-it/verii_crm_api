...
namespace crm_api.Modules.Stock.Application.Mappings
{
    public class StockImageMappingProfile : Profile
    {
        public StockImageMappingProfile()
        {
            // StockImage mappings
            ...
            CreateMap<StockImageDto, StockImage>();
            ...
            CreateMap<StockImageUpdateDto, StockImage>()
                .ForMember(dest => dest.Id, opt => opt.Ignore())
