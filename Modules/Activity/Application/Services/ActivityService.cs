...
namespace crm_api.Modules.Activity.Application.Services
{
    public class ActivityService : IActivityService
    {
        ...
        [
            ...
            nameof(ActivityEntity.ErpCustomerCode),
            "ActivityType.Name",
        ...
        public async Task<ApiResponse<PagedResponse<ActivityDto>>> GetAllActivitiesAsync(PagedRequest request)
        {
            try
            {
                ...
                var sortBy = request.SortBy ?? nameof(ActivityEntity.Id);
        ...
        public async Task<ApiResponse<ActivityDto>> CreateActivityAsync(CreateActivityDto createActivityDto)
        {
            try
            {
                ...
                var activity = _mapper.Map<ActivityEntity>(createActivityDto);
        ...
        private async Task<ActivityEntity?> LoadActivityWithRelationsAsync(long id, bool asNoTracking)
        {
            var query = _unitOfWork.Activities.Query();
            if (asNoTracking)
            {
