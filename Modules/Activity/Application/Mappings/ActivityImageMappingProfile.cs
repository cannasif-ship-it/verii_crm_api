...
namespace crm_api.Modules.Activity.Application.Mappings
{
    public class ActivityImageMappingProfile : Profile
    {
        public ActivityImageMappingProfile()
        {
            ...
            CreateMap<CreateActivityImageDto, ActivityImage>()
            ...
            CreateMap<UpdateActivityImageDto, ActivityImage>()
                .ForMember(dest => dest.Id, opt => opt.Ignore())
                .ForMember(dest => dest.Activity, opt => opt.Ignore())
