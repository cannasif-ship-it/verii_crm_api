...
namespace crm_api.Modules.Activity.Infrastructure.Persistence.Configurations
{
    public class ActivityConfiguration : BaseEntityConfiguration<ActivityEntity>
    {
        protected override void ConfigureEntity(EntityTypeBuilder<ActivityEntity> builder)
        {
