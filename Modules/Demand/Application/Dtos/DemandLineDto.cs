...
namespace crm_api.Modules.Demand.Application.Dtos
{
    public class DemandLineDto : BaseEntityDto
    {
    ...
    public class CreateDemandLineDto
    {
        [Required]
        public long DemandId { get; set; }
    ...
    public class UpdateDemandLineDto
    {
        [Required]
        public long ProductId { get; set; }
    ...
    public class DemandLineGetDto : BaseEntityDto
    {
        public long DemandId { get; set; }
        public long? ProductId { get; set; }
        public string? ProductCode { get; set; } = string.Empty;
