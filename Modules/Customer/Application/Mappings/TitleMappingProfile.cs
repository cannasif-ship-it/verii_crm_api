...
namespace crm_api.Modules.Customer.Application.Mappings
{
    public class TitleMappingProfile : Profile
    {
        public TitleMappingProfile()
        {
            ...
            CreateMap<Title, TitleDto>()
                .ForMember(dest => dest.Contacts, opt => opt.MapFrom(src => src.Contacts != null ? src.Contacts.Where(c => !c.IsDeleted).ToList() : null))
