...
namespace crm_api.Shared.Infrastructure.Persistence
{
    public class CmsDbContext : DbContext
    {
        ...
        public DbSet<crm_api.Modules.Catalog.Domain.Entities.ProductCatalog> ProductCatalogs { get; set; }
        public DbSet<crm_api.Modules.Catalog.Domain.Entities.ProductCategory> ProductCategories { get; set; }
        public DbSet<crm_api.Modules.Catalog.Domain.Entities.CatalogCategory> CatalogCategories { get; set; }
        public DbSet<crm_api.Modules.Catalog.Domain.Entities.StockCategory> StockCategories { get; set; }
        public DbSet<crm_api.Modules.Catalog.Domain.Entities.ProductCategoryRule> ProductCategoryRules { get; set; }
